  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <?php echo form_open('varietas/edit/'. $varietas['id_varietas']) ?>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Nama Varietas</label>
              <input type="text" name="nama_varietas" class="form-control" value="<?php echo $varietas['nama_varietas'] ?>" required>
            </div>

            <div class="form-group">
              <label>Kode</label>
              <input type="text" name="kode" class="form-control" value="<?php echo $varietas['kode'] ?>" required>
            </div>
