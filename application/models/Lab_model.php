...
class Lab_model extends CI_Model {
	...
	public function get_all($id_lab){ 
		if($id_lab == NULL){
			$query = $this->db->query("SELECT * FROM lab");		
			return $query->result_array();	
		}else{
			$query = $this->db->query("SELECT * FROM sertifikasi,jenis_tanaman, varietas, lab, kelas_benih WHERE sertifikasi.id_jenis_tanaman = jenis_tanaman.id_jenis_tanaman AND sertifikasi.id_varietas = varietas.id_varietas AND sertifikasi.id_kelas_benih = kelas_benih.id_kelas_benih AND lab.id_lab = $id_lab");
