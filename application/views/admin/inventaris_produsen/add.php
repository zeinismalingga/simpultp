        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="lamanya_usaha" class="form-control" required>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" name="modal_kerja" class="form-control" required>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label>Kapasitas Produksi (ton/th)</label>
              <input type="text" name="kapasitas_produksi" class="form-control" required>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" name="kemampuan_produksi" class="form-control" required>
          </div>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label>Ijin Produksi</label>
          <input type="text" name="ijin_produksi" class="form-control" required>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="text" name="mendapat_bantuan" class="form-control" required>
      </div>
    </div>
