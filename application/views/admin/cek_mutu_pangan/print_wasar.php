	...
	<div>
		...
		<div class="float-right" style="margin-right: 100px;">
			<table>
				...
				<tr>
					<td><strong><?php echo $cek_mutu['nama_produsen'] ?></strong></td>
				</tr>
				<tr>
					<td><?php echo $cek_mutu['alamat'] ?></td>
				</tr>
				<tr>
					<td>di-</td>
				</tr>
				<tr>
					<td>&emsp;&emsp; <span style="text-decoration: underline;"><?php echo ucwords($cek_mutu['nama_kota']) ?></span></td>
				</tr>
			</table>
		</div>
	</div>
