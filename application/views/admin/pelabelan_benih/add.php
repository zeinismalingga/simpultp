        ...
        <div class="row">
          ...
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="no_awal" class="form-control" required>
            </div>
          </div>
          ...
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="no_akhir" class="form-control" required>
            </div>
          </div>
          ...
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="berat_kemasan" class="form-control" required>
            </div>
          </div>
          ...
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="jml_lembar" class="form-control" required>
            </div>
          </div> 
          ...
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="total_terlabel" class="form-control" required>
            </div>
          </div> 
