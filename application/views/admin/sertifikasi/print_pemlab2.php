...
<body>
	...
	<?php 
		$tgl_pemlap = date_create($sertifikasi['tgl_pemlap_2']);
	?>

	<div style="margin-top: 20px; text-align: center;">
		<p style="text-decoration: underline;">SURAT PENGANTAR</p>
		<p>Nomor : 521.211 / <?php echo $sertifikasi['no_pemlap2'] ?> /PSBTPH/ <?php echo date_format($tgl_pemlap, "m") ?>. <?php echo date_format($tgl_pemlap, "Y") ?></p>
	</div>
	...
	<table class="table table-borderless">
		...
		<tr>
			<td width="4%">1.</td>
			<td>Laporan Pemeriksaan Lapangan Ke II </td>
			<td></td>
		...
		<tr>
			<td width="4%"></td>
			<td><?php echo $sertifikasi['no_induk'] ?> / 3</td>
			<td></td>
			<td>mana mestinya</td>
		</tr>
	</table>
	...
	<div class="row">
		...
		<div class="col-sm-4 text-center">
			<p>Samarinda, <?php echo tgl_indo($sertifikasi['tgl_pemlap_2']) ?></p>
